 ...
 * 2020-08-14T17:19:34.120+08:00
 * Generated source version: 2.4.2
 * 
 */
@WebServiceClient(name = "ISysSynchroGetOrgWebServiceService", 
                  wsdlLocation = "http://172.16.3.28:8080/sys/webservice/sysSynchroGetOrgWebService?wsdl",
...
public class ISysSynchroGetOrgWebServiceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://172.16.3.28:8080/sys/webservice/sysSynchroGetOrgWebService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ISysSynchroGetOrgWebServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://172.16.3.28:8080/sys/webservice/sysSynchroGetOrgWebService?wsdl");
        }
        WSDL_LOCATION = url;
    }
